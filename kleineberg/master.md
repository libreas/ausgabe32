...
Open-Access-Verlagspublikation oder "Grüner Weg" im Sinne einer
...
(3) Der Nachvollzug von Forschungsergebnissen erfordert den freien Zugang zu den Forschungsdaten bzw. angewandten Softwaretools. \[66, 67, 68, 69, 70, 106, 112\]
...
3.  "*Ich finde schon, dass Wissenschaftler, die irgendwie öffentlich
...
12. "*Gerade global gesehen ist Open Access wichtig, da die
...
25. "*Ob meine eigenen Publikationen Open Access erscheinen, hängt von
...
37. "*Wenn die Forschungsgeldgeber nicht so viel finanzieren, dass sie
...
58. "*Das Internet ist mit dem Makel des Amateurhaften behaftet.
...
3.  "*Es dürfen ja eigentlich nicht nur die Forschungsdaten
...
13. "*Eine einzige Umgebung für alle Arbeitsprozesse halte ich nicht für
...
22. "*Wenn man von Anfang an weiß, dass man das mit verschiedenen Leuten
...
33. "*Digitale Publikationen senken die Schwelle, damit werden z.B.
...
44. "*Die Historie der Forschungsdaten sollte sichtbar gemacht werden*."
    \[Interview 04\]
...
56. "*Mein Lieblingsindex bei meiner eigenen Datenbank ist der
...
64. "*Wir haben bei unserem Portal auch ein internes Diskussionsforum,
...
8.  "*Ein großes Problem ist, für Online-Publikationen Rezensionen zu
...
20. "*Von Open Peer Review halte ich nicht soviel. Bei einem
...
[^1]: Anmerkung der Redaktion: Dieser Text gibt den Stand von 2015
    wieder. Er ist 2016 als Preprint auf zenodo.org erschienen
    (Kleineberg, Michael (2016): Open Humanities? Expertenmeinungen über
    Open Access in den Geisteswissenschaften. DOI:
    http://doi.org/10.5281/zenodo.50598. Er ist außerdem kooperativ
    redigiert mit KollegInnen vom Institut für Dokumentologie und
    Editorik e.V., die eine weitere Veröffentlichung planen.
...
[^9]: Heidelberger Appell (2009):
    <http://www.textkritik.de/urheberrecht/appell.pdf>; vgl. auch Reuß &
    Rieble 2009, Jochum 2009.

[^10]: Vgl. Helmholtz-Gemeinschaft 2015, Bartling & Friesike 2014, Herb
    2012, Kraker et al. 2012, openscienceASAP:
    <http://openscienceasap.org/open-science/>; Paris Open Educational
...
[^18]: Vgl. auch den Beitrag "Zur Epistemologie digitaler Methoden in
    den Geisteswissenschaften" von Ben Kaden in diesem Band.
...
[^21]: Der Interview-Leitfaden sowie ein vollständiges exemplarisches
    Interview mit Christian Heise sind veröffentlicht in Heise 2015. Für
    eine erste Trendanalyse zu den ExpertInneninterviews vgl. Kaden &
    Kleineberg 2015.

[^22]: Zur qualitativen Inhaltsanalyse anhand induktiver
    Kategorienbildung vgl. Mayring 2008, Kuckartz et al. 2007.

[^23]: Eine umfassende Sammlung von anonymisierten Einzelaussagen sind
    über das im Projekt entwickelte Retrieval-Tool "Statement Finder"
    als Forschungsdatenpublikation verfügbar:
...
[^30]: Ein Verlagsbeispiel für Open-Access-Monografien bietet Language
    Science Press: <http://langsci-press.org/>.

[^31]: ScienceOpen: <https://www.scienceopen.com/home>.

[^32]: Die einzelnen Grundaussagen können sich zum Teil widersprechen,
    da es sich lediglich um die Abbildung eines vielschichtigen und
    vielstimmigen Meinungsbildes handelt. Die Referenzen in den eckigen
    Klammern verweisen auf konkrete ExpertInnenaussagen, die –
    gegebenenfalls leicht paraphrasiert – den Interviewprotokollen
...
[^35]: Beispiele für Forschungsdatenrepositorien in den
    Geisteswissenschaften sind das interdisziplinäre TextGriD
    Repository: <http://www.textgridrep.de/>; das Laudatio Repository
    für die historische Korpuslinguistik:
    <http://www.laudatio-repository.org/repository/>; oder Arachne für
    die Archäologie:
    [http://arachne.uni-koeln.de/drupal/?q=node/3](http://arachne.uni-koeln.de/drupal/?q=de/node/3).
    Einen Überblick bietet das Verzeichnis re3data.org:
    <http://www.re3data.org/>.

[^36]: Ein Beispiel für das Freemium-Geschäftsmodell, bei dem eine
    einfache Version Open Access publiziert wird und eine erweiterte
    Version kostenpflichtig ist, bietet die französische
    Publikationsplattform Open Edition:
    <http://www.openedition.org/14043?lang=en>.

[^37]: Zur Unterscheidung von Forschungsdaten, Zusatzmaterial und
    Postpublikationsdaten im Zusammenhang mit Enhanced Publications vgl.
    Vernooy-Gerritsen 2009.

[^38]: Gemeinsame Normdatei:
    http://www.dnb.de/DE/Standardisierung/GND/gnd\_node.html

[^39]: Vgl. Wiljes et al. 2013, Stäcker 2013.

[^40]: Ein Beispiel für alternative Impact-Messverfahren auf
    Artikelebene bietet Altmetrics: <http://www.altmetric.com/>.

[^41]: Den historischen Fall der Sonderdrucke einmal ausgenommen.

[^42]: Vgl. Edition TOPOI: <http://edition-topoi.org/>, PloS:
    <https://www.plos.org/>.

[^43]: Vgl. Heise 2015.

[^44]: Die Zeitschrift LCC wurde im Dezember 2014 umbenannt in DSH –
    *Digital Scholarship in the Humanities*,
    <http://llc.oxfordjournals.org/>. Für Open-Access-Journals im
    DH-Bereich siehe Brill Open Humanties:
    <http://booksandjournals.brillonline.com/content/journals/23527064>;
    Journal of Digital Humanities:
    <http://journalofdigitalhumanities.org/>; Zeitschrift für digitale
    Geisteswissenschaften: <http://zfdg.de/>.
